...
class CSSDelegateTest < Minitest::Test
  ...
  context(Darkroom::Asset::CSSDelegate, '::import_regex') do
  ...
  context(Darkroom::Asset::CSSDelegate, '::reference_regex') do
  ...
  context(Darkroom::Asset::CSSDelegate, '::validate_reference') do
  ...
  context(Darkroom::Asset::CSSDelegate, '::reference_content') do
