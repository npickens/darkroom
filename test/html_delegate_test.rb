...
class HTMLDelegateTest < Minitest::Test
  ...
  context(Darkroom::Asset::HTMLDelegate, 'reference_regex') do
  ...
  context(Darkroom::Asset::HTMLDelegate, 'validate_reference') do
  ...
  context(Darkroom::Asset::HTMLDelegate, 'reference_content') do
