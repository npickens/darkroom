...
class HTMLDelegateTest < Minitest::Test
  ...
  test('self.validate_reference returns error if <link> tag references non-CSS asset with displace '\
      'format') do
  ...
  test('self.validate_reference returns no error if <link> tag references CSS asset with displace
      format') do
    error = Darkroom::Asset::HTMLDelegate.validate_reference.(
      new_asset('/app.css'),
  ...
  test('self.validate_reference returns error if <script> tag references non-JavaScript asset with '\
      'displace format') do
    error = Darkroom::Asset::HTMLDelegate.validate_reference.(
      new_asset('/robots.txt'),
  ...
  test('self.validate_reference returns no error if <script> tag references JavaScript asset with '\
      'displace format') do
    error = Darkroom::Asset::HTMLDelegate.validate_reference.(
      new_asset('/app.js'),
  ...
  test('self.validate_reference returns error if <img> tag references non-SVG asset with displace '\
      'format') do
    error = Darkroom::Asset::HTMLDelegate.validate_reference.(
      new_asset('/robots.txt'),
  ...
  test('self.validate_reference returns no error if <img> tag references SVG asset with displace format') do
    error = Darkroom::Asset::HTMLDelegate.validate_reference.(
      new_asset('/logo.svg'),
  ...
  test('self.validate_reference returns error if tag isn\'t <link>, <script>, or <img> with displace '\
      'format') do
  ...
  test('self.reference_content returns <style>...</style> for <link> tag reference with displace format') do
  ...
  test('self.reference_content returns <script>... for <script> tag reference with displace format') do
    result = Darkroom::Asset::HTMLDelegate.reference_content.(
  ...
  test('self.reference_content returns SVG content for <img> tag reference with displace format') do
    result = Darkroom::Asset::HTMLDelegate.reference_content.(
  ...
  test('self.reference_content substitutes quotes if needed with utf8 format') do
    result = Darkroom::Asset::HTMLDelegate.reference_content.(
