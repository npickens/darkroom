...
class AssetTest < Minitest::Test
  ...
  context(Darkroom::Asset, '#initialize') do
  ...
  context(Darkroom::Asset, '#content_type') do
  ...
  context(Darkroom::Asset, '#binary?') do
  ...
  context(Darkroom::Asset, '#font?') do
  ...
  context(Darkroom::Asset, '#image?') do
  ...
  context(Darkroom::Asset, '#headers') do
  ...
  context(Darkroom::Asset, '#integrity') do
    test('returns subresource integrity string according to algorithm argument') do
      ...
      assert_equal('sha512-VAhb8yjzGIyuPN8kosvMhu7ix55T8eLHdOqrYNcXwA6rPUlt1/420xdSzl2SNHOp93piKyjcNkQwh2L'\
        'w8imrQA==', asset.integrity(:sha512))
    end
  ...
  context(Darkroom::Asset, '#internal?') do
  ...
  context(Darkroom::Asset, '#error?') do
  ...
  context(Darkroom::Asset, '#inspect') do
